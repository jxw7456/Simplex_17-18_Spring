...
void Application::Display(void)
{
	...
	case 3:
		...
		// Set Position, Target, and Up Planes of the camera
		m_pCamera->SetPositionTargetAndUp(vector3(10.0f, 0.0f, 0.0f), vector3(0.0f, 0.0f, -1.0f), vector3(0.0f, 0.0f, -1.0f));
		
		// Set Horizontal and Vertical Planes of the camera
	...
	case 5:
		...
		// Sets Near and Far planes of the camera
	...
	// Calculate Projection and View Matrix no matter the case
